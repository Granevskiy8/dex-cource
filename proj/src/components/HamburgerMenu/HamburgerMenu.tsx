...
`;
const Item = styled.div`padding-top: 32px;`;
const Teams = styled.div`
    display: flex;
    justify-content: center;
`;
const Players = styled(Teams)`padding-top: 36px;`;
const SingOut = styled(Teams)`padding-bottom: 32px;`;
const Logo = styled.svg`
    fill: #9C9C9C;
    cursor: pointer;
`;
const LogoOut = styled(Logo)`fill: #FF768E;`;
const Text = styled.p`
    font-size: 12px;
    color: #9C9C9C;
    line-height: 18px;
    ...
    margin-bottom: 0;
`;
const TextOut = styled(Text)`color: #FF768E;`;
